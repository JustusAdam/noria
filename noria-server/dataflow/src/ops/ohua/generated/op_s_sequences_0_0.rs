    ...
    // <end(udf-name)>
{
    ...
    // <begin(udf-args-sigs)>
    udf_arg_placeholder: usize,
    // <end(udf-args-sigs)>

    // <begin(node-properties)>
    sequences_0__1__index: usize,
    sequences_0__2__index: usize,
    // <end(node-properties)>
    ...
    // <end(udf-name)>
{
    ...
    fn typ_static() -> Self::Type {
        ...
        crate::state::click_ana::iseq::ClickAnaInner
        // <end(udf-state-type)>
            ::typ_static()
    }
}
    ...
    // <end(udf-name)>
{
    pub fn new(
        ...
        // <end(udf-name)>
            ...
            // <begin(node-property-args)>
            sequences_0__1__index,
            sequences_0__2__index,
            // <end(node-property-args)>
        ...
        let mut out = Vec::new();
        {
            ...
            let mut handle_group =
                |group_rs: ::std::vec::Drain<Record>, diffs: ::std::vec::Drain<_>| {
                    ...
                    let new = {
                        ...
                        let v = {
                            // <begin(reduce)>
                            let sequences_0 = computer;let i = sequences_0.compute_new_value();
                            i
                            // <end(reduce)>
                        };
            ...
            for r in rs {
                ...
                let moved_row = {
                    ...
                    let _ = {
                        // <begin(map)>
                        use crate::state::click_ana::iseq::Action;
                        let _ = {
                            let ilv__1_0 : &i32 = &a_0[self.sequences_0__1__index].clone().into();
                            let ilv__2_0 : &i32 = &a_0[self.sequences_0__2__index].clone().into();
                            let category_0 = ilv__1_0;
                            let timestamp_0 = ilv__2_0;
                            let time_0 = *timestamp_0;
                            let cat_0 = *category_0;
                            let b = cat_0 == 1;
                            let h = (if b {
                                let d = diffs.push((Action::Open(time_0), r_is_positive));
                                d
                            } else {
                                let c = cat_0 == 2;
                                let g = (if c {
                                    let e = diffs.push((Action::Close(time_0), r_is_positive));
                                    e
                                } else {
                                    let f = diffs.push((Action::Insert(time_0), r_is_positive));
                                    f
                                });
                                g
                            });
