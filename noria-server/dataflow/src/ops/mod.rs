...
pub enum NodeOperator {
    ...
    Op_s_sequences_0_0udf(ohua::generated::op_s_sequences_0_0::Op_s_sequences_0_0),
...
nodeop_from_impl!(NodeOperator::Op_s_sequences_0_0udf, ohua::generated::op_s_sequences_0_0::Op_s_sequences_0_0);
...
macro_rules! impl_ingredient_fn_mut {
    ($self:ident, $fn:ident, $( $arg:ident ),* ) => {
        match *$self {
            ...
            NodeOperator::Op_s_sequences_0_0udf(ref mut i) => i.$fn($($arg),*),
...
macro_rules! impl_ingredient_fn_ref {
    ($self:ident, $fn:ident, $( $arg:ident ),* ) => {
        match *$self {
            ...
            NodeOperator::Op_s_sequences_0_0udf(ref i) => i.$fn($($arg),*),
